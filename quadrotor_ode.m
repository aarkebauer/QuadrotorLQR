...
global T Tmax ts tmax m g M Ax Ay Az C J w1 w2 w3 w4 l k b Ixx Iyy Izz ...
    R_cost Q_cost B P int_out K_int...
...
% int_out = int_out + (state - desired_state(t));
...
w1 = sqrt(omega_opt_squared(1));
w2 = sqrt(omega_opt_squared(2));
w3 = sqrt(omega_opt_squared(3));
w4 = sqrt(omega_opt_squared(4));
